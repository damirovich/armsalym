...
public partial class TotalNumberOfPhoto : ContentPage // ïîêàçûâàåò êîëè÷åñòâî ôîòîãðàôèé íà íîâîé ñòðàíèöå
{
    ...
    private async void LoadDataFromService()
    {
        ...
        string path = $"{inn}\\ZAVKR\\{ZvPozn}\\ResidencePhoto"; // передать через сессию! до открытия страницы
